...
class UI_Cutwood(QMainWindow):
    ...
    def displayTable1(self):
        ...
        # self.cuttingTable1.setHorizontalHeaderItem(0, QTableWidgetItem("โค้ดไม้"))
        ...
        # self.cuttingTable1.setHorizontalHeaderItem(7, QTableWidgetItem("สถานะ"))
    ...
    def funcFetchData(self):
        ...
        for row_data in query:
            ...
            self.cuttingTable1.setCellWidget(row_number, 8, self.qch_select)
    ...
    def funchandleButtonClicked(self):
        global Input_id
        listInput = []
        print("Is ", self.qch_select.isChecked())
        for row in range(0,8):
            if self.qch_select.isChecked() == True:
                listInput.append(self.cuttingTable1.item(self.cuttingTable1.currentRow(), row).text())
            elif self.qch_select.isChecked() == False:
